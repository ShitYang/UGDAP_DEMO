...
public class ScatterAttackComponent : AbstractAttackComponent
{
    ...
    public override void Attack(Vector2 startPoint, Vector2 forward) {
        ...
        GameObject projectileGameObject = Instantiate(projectilePrefab, startPoint + newForward * (new Vector2(0.8f, 0.8f)), Quaternion.identity);
        projectileGameObject.transform.up = newForward;
